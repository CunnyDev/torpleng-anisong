...
export const songs: AniSong[] = [
  ...
  },
  {
    kana: {
      ...
      author: 'nao',
      lyrics:
        'そう{今,いま}{全,すべ}ての{次元,じげん}が {結,むす}ばれる{様,よう}に{明日,あひた}を{飛,と}び{超,こ}えて まだ{見,み}えない{新,あら}たな{歴史,れきし}を {描,えが}けるように…「Fortune favors the brave.」{Dimension Tripper!!!!,ディメンション・トリッパー}'
    },
    romaji: {
      name: 'Dimension Tripper!!!!',
      author: 'nao',
  ...
  },
  {
    kana: {
      ...
      author: 'メグ (村川梨衣)',
      lyrics:
        'パパパまるでパーティー おんなのこ{集,あつ}まるだけでハッピーディ そんな{毎日,まいにち} るんるんるんステップ{踏,ふ}んで はなうた♪{歌,うた}っちゃって お{気,き}に{入,い}りの{時間,じかん}を{過,す}ごしたいな…って{考,かんが}えて ほっぺがゆるんでしまうよ'
    },
    romaji: {
  ...
  },
  {
    kana: {
      ...
      lyrics:
        '({捧,ささ}げ)よ！　{捧,ささ}げよ！　{心臓,しんぞう}を{捧,ささ}げよ！ {全,すべ}ての{犠牲,ぎせい}は　{今,いま}この{瞬間,とき}のために {捧,ささ}げよ！　{捧,ささ}げよ！　{心臓,しんぞう}を{捧,ささ}げよ！ {進,すす}むべき{未来,みらい}を　その{手,て}で{切,き}り{拓,ひら}け……'
    },
    romaji: {
  ...
  },
  {
    kana: {
      ...
      author: '水瀬いのり',
      lyrics:
        "({気付,きづ})けばキミとの{旅,たび}{支,じ}{度,たく} モノクロに{輝,かがや}く{楽園,らくえん}へLet's go {作,つく}りましょ {作,つく}りましょ あなたと私の{世界,せかい}をさあ{作,つく}りましょ {始,はじ}めましょ {始,はじ}めましょ {何,なに}から{始,はじ}めましょ？"
    },
    romaji: {
      name: 'More One Night',
      author: 'Inori Minase',
